...
ActiveRecord::Schema.define(version: 20161119054402) do
  ...
  create_table "buyer_referral_leads", force: :cascade do |t|
    t.integer  "buyer_id"
    t.text     "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "project_offers", force: :cascade do |t|
